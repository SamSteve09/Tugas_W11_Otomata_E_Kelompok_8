...
def cyk_algorithm(varies, terms, inp):
    length = len(inp)
...
def print_result(tab, inp):
    ...
    if 'S' in tab[len(inp)-1][0]:
        print("Belong to this context free grammar")
    else:
        print("Doesn't belong to this context free grammar")

v, t = read_grammar()
r = read_input()[0]
ta = cyk_algorithm(v, t, r)
print_result(ta, r)